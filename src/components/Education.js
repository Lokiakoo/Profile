        ...
        className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col justify-between md:w-[80%]'>
            ...
            <div>
                ...
                {/* <p className='capitalize font-medium text-dark dark:text-light/75 md:text-sm sm:text-sm'>
                 ...
                 <p
                    className='capitalize font-medium text-dark dark:text-light/75 md:text-sm sm:text-sm'
    ...
    <div className='my-64'>
        ...
        <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
            ...
            <ul className='w-full flex flex-col items-center justify-between ml-4 xs:ml-2'>
                ...
                time="Nov 2023 - Jan 2025"
                place="Conventry University & IVE"
                info="<br />
                Data Science - Specialized in utilizing Python and R for data manipulation and visualization.<br /><br />
                Web Development - Focused on developing dynamic and backend architecture, use tech like React, CSS, TypeScript, JWT, unit test automation. Built a full-stack solutions, including RESTful APIs and databases.<br /><br />
                Mobile Applications - Build cross-platform mobile apps using EXPO GO and React Native. Delivered practical projects addressing user experience, performance optimization, and seamless integration with APIs.<br /><br />
                Security - Includes vulnerability assessment, network security, and encryption methods.<br /><br />
                UI/UX Design - Aims to create visually appealing and user-friendly interfaces. Use tools like Figma to prototype and iterate on designs."
                />
                <Details
